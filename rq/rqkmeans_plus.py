...
def parse_args():
    ...
    parser.add_argument("--pretrained_codebook_path", type=str, required=True, help="Path to RQ-KMeans npz file")
...
if __name__ == "__main__":
    ...
    if args.e_dim != data.dim:
        logging.error(
            f"CRITICAL: For RQ-KMeans+ residual connection, 'e_dim' ({args.e_dim}) "
