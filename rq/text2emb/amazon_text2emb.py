    ...
    with torch.no_grad():
        for i in range(0, len(local_texts), batch_size):
            ...
            encoded_sentences = tokenizer(
                batch_texts, max_length=args.max_sent_len, truncation=True, return_tensors="pt", padding=True
...
if __name__ == "__main__":
    ...
    generate_item_embedding(
        args, item_text_list, plm_tokenizer, plm_model, accelerator, word_drop_ratio=args.word_drop_ratio
    )
